...
graphs_max_4 = [build_graph_from_chain(lcot, max_path_length_for_nli=3, logfile=open(f"/lustre/fswork/projects/rech/rqn/ugy38tw/.local/max_4_fusion/{i}.txt","w+")) for i, lcot in enumerate(lcots)]
print("Done with 2: Max 4")
graphs_max_5 = [build_graph_from_chain(lcot, max_path_length_for_nli=3, logfile=open(f"/lustre/fswork/projects/rech/rqn/ugy38tw/.local/max_5_fusion/{i}.txt","w+")) for i, lcot in enumerate(lcots)]
print("Done with 3: Max 5")
graphs_max_6 = [build_graph_from_chain(lcot, max_path_length_for_nli=3, logfile=open(f"/lustre/fswork/projects/rech/rqn/ugy38tw/.local/max_6_fusion/{i}.txt","w+")) for i, lcot in enumerate(lcots)]
print("Done with 4: Max 6")
graphs_max_7 = [build_graph_from_chain(lcot, max_path_length_for_nli=3, logfile=open(f"/lustre/fswork/projects/rech/rqn/ugy38tw/.local/max_7_fusion/{i}.txt","w+")) for i, lcot in enumerate(lcots)]
print("Done with 5: Max 7")
graphs_max_8 = [build_graph_from_chain(lcot, max_path_length_for_nli=3, logfile=open(f"/lustre/fswork/projects/rech/rqn/ugy38tw/.local/max_8_fusion/{i}.txt","w+")) for i, lcot in enumerate(lcots)]
print("Done with 6: Max 8")
graphs_max_10 = [build_graph_from_chain(lcot, max_path_length_for_nli=3, logfile=open(f"/lustre/fswork/projects/rech/rqn/ugy38tw/.local/max_10_fusion/{i}.txt","w+")) for i, lcot in enumerate(lcots)]
