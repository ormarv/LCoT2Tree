...
srun src/cot2tree/main.py train test -L -D ~/.local/lcots -d ~/.local/graphs -G ~/.local/construction_log_file.txt -v -F nb_parents nb_children node_index distance_to_end nb_words_before nb_nodes_per_depth
